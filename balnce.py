...
fvethusn=int(raw_input("5000 x " ))
thusn=int(raw_input("1000 x " ))
fvehnred=int(raw_input("500 x " ))
hnred=int(raw_input("100 x " ))
ffty=int(raw_input("50 x " ))
twnty=int(raw_input("20 x " ))
ten=int(raw_input("10 x " ))
fve=int(raw_input("5 x " ))
yester=int(raw_input("Yesterday Cash : " ))
a_exp=int(raw_input("+ Additional Expenses : " ))
a_inc=int(raw_input("- Additional Incomes : " ))
